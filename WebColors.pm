############################################################################
# WebColors - returns various color sets for consistent web usage.
#             This module has a set of color palettes for different purposes.
#             These palettes are represented by sets of RGB values.
#
#                 (obtained from MG-RAST - anl.gov).
#                 Used by RadialTree.pm
# $Id: WebColors.pm 29739 2014-01-07 19:11:08Z klchu $
############################################################################
package WebColors;
use strict;
use warnings;
