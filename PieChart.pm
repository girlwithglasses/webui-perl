############################################################################
# PieChart - component to create pie charts. Creates an inline image for a 
#            pie chart with mouseover/onlick regions.
#            (obtained from MG-RAST - anl.gov).
#            Used by RadialTree.pm
#
# $Id: PieChart.pm 29739 2014-01-07 19:11:08Z klchu $
############################################################################
package PieChart;
use strict;
use warnings;
